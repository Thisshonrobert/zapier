...
| **`ai_agent`**                                           | [`apps/ai_agent`](../apps/ai_agent)               | Bun / Express service (port `3004`) running a read-only LangGraph.js DLQ triage investigator with strict Zod contracts and grounding guardrails.                                                                                           |
