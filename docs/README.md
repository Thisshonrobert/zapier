...
| [**`kafka.md`**](./kafka.md)                               | Kafka messaging architecture, topics, producers, consumers, consumer groups, offset commit model, and durable failure publication. | `zap-events`, `zap-events-dlq`, KafkaJS             |
