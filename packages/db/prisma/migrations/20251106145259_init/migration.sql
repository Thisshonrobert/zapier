...
-- CreateTable
CREATE TABLE "AvailableTriggerType" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,

    CONSTRAINT "AvailableTriggerType_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Trigger" ADD CONSTRAINT "Trigger_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "AvailableTriggerType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
